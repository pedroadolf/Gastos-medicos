  ...
  return (
    <div className="gmm-box relative overflow-hidden group">
      ...
      <div className="flex flex-col lg:flex-row border-b border-slate-100 dark:border-zinc-800">
        ...
        <div className="flex-1 p-8 lg:p-10 lg:border-r border-slate-100 dark:border-zinc-800">
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-y-4">
               <div>
                 <p className="text-[9px] font-bold text-slate-400 dark:text-zinc-500 uppercase tracking-widest mb-1">No. de Póliza</p>
                 <p className="text-[14px] font-black text-slate-900 dark:text-white uppercase">{policyNumber}</p>
               </div>
               <div>
                 <p className="text-[9px] font-bold text-slate-400 dark:text-zinc-500 uppercase tracking-widest mb-1">Contratante</p>
                 <p className="text-[12px] font-black text-slate-900 dark:text-white">Colgate Palmolive, S.A. de C.V.</p>
               </div>
               <div>
                 <p className="text-[9px] font-bold text-slate-400 dark:text-zinc-500 uppercase tracking-widest mb-1">Certificado</p>
                 <p className="text-[12px] font-black text-slate-900 dark:text-white">2001</p>
               </div>
               <div>
                 <p className="text-[9px] font-bold text-slate-400 dark:text-zinc-500 uppercase tracking-widest mb-1">Vigencia</p>
                 <p className="text-[12px] font-black text-emerald-500">En vigor</p>
               </div>
               <div>
                 <p className="text-[9px] font-bold text-slate-400 dark:text-zinc-500 uppercase tracking-widest mb-1">Suma Asegurada</p>
                 <p className="text-[14px] font-black text-slate-900 dark:text-white">${(totalSum/1000000).toFixed(0)},000,000 MXN</p>
               </div>
               <div>
                 <p className="text-[9px] font-bold text-slate-400 dark:text-zinc-500 uppercase tracking-widest mb-1">Deducible</p>
                 <p className="text-[12px] font-black text-slate-900 dark:text-white">$15,000 MXN / siniestro</p>
               </div>
               <div>
                 <p className="text-[9px] font-bold text-slate-400 dark:text-zinc-500 uppercase tracking-widest mb-1">Coaseguro</p>
                 <p className="text-[12px] font-black text-slate-900 dark:text-white">10% <span className="text-[10px] text-slate-400 dark:text-zinc-500">(tope $17,500 MXN)</span></p>
               </div>
               <div>
                 <p className="text-[9px] font-bold text-slate-400 dark:text-zinc-500 uppercase tracking-widest mb-1">Asegurado Titular</p>
        ...
        <div className="lg:w-[400px] bg-slate-50 dark:bg-zinc-900/50 p-8 lg:p-10 relative">
          ...
          <div className="space-y-4 relative z-10">
             <div className="grid grid-cols-1 gap-y-4">
               ...
               <div className="grid grid-cols-2 gap-4">
                  <div>
                    <p className="text-[9px] font-bold text-slate-400 dark:text-zinc-500 uppercase tracking-widest mb-1">Inicio Vigencia</p>
               ...
               <div className="grid grid-cols-2 gap-4">
                  <div>
                    <p className="text-[9px] font-bold text-slate-400 dark:text-zinc-500 uppercase tracking-widest mb-1">Deducible Excesos</p>
                    <p className="text-[12px] font-black text-slate-900 dark:text-white">$2,000,000 MXN</p>
                  </div>
                  <div>
                    <p className="text-[9px] font-bold text-slate-400 dark:text-zinc-500 uppercase tracking-widest mb-1">Coaseguro Excesos</p>
                    <p className="text-[12px] font-black text-slate-900 dark:text-white">10%</p>
                  </div>
               </div>
            </div>

            <div className="mt-6 p-4 bg-white dark:bg-zinc-950 rounded-[16px] border border-slate-100 dark:border-zinc-800">
              <p className="text-[10px] leading-relaxed font-bold text-slate-400 dark:text-zinc-500">
      ...
      {/* Footer KPI Cards */}
      <div className="grid grid-cols-2 lg:grid-cols-4 divide-y lg:divide-y-0 lg:divide-x divide-slate-100 dark:divide-zinc-800 bg-slate-50 dark:bg-zinc-900/80">
